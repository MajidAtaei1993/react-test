...
export default function Product() {
    ...
    return (
        <div className="prodcust-section container mx-auto">
            ...
            {/* product content */}
            <div className="columns-2 gap-6 grid lg:grid-cols-2 sm:grid-cols-1">
                {/* iamge gallery */}
                ...
                <div className="bg-gray-200 details">
                    ...
                    <button className="bg-indigo-700 rounded-lg hover:bg-indigo-900 hover:text-white border-none lg:w-1/2 capitalize text-[18px]">add to bag</button>
                    <div className="more-details my-6">
                        ...
                        <div className="columns-auto lg:columns-2 gap-4 mt-6">
                            <div className="card text-center justify-center items-center flex flex-col gap-1 p-4">
